...
public class InterfaceBaidu {

    //    百度接口 文本暴力审核
    public static final String BAIDU_TEXT_URL="https://aip.baidubce.com/rest/2.0/antispam/v2/spam";

    // 官网获取的 API Key 更新为你注册的
    static String clientId = "wOLBi1vGsGQyRlAB0mOKVKGg";
    // 官网获取的 Secret Key 更新为你注册的
    static String clientSecret = "gYqV0LV4GIFNcB5WcK0RrrkPrAtFpeua";
...
//    access_token	通过API Key和Secret Key获取的access_token,
    ...
    private static void getToken(Context context, OnAuth onAuth) throws IOException {
        String token = MySP.getTime(context, SP_KEY, "");
        if(token.length() == 0) {
    ...
    public static void getAuth(Context context, OnAuth onAuth) throws IOException {
        ...
        String getAccessTokenUrl = authHost
                ...
                // 2. 官网获取的 API Key
                + "&client_id=" + InterfaceBaidu.clientId
                // 3. 官网获取的 Secret Key
                + "&client_secret=" + InterfaceBaidu.clientSecret;
        ...
        OkHttpUtil.get(getAccessTokenUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                MySP.putTime(context, SP_KEY, access_token, 10 * 24 * 3600 * 1000);
